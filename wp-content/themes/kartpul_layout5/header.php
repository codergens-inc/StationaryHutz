...
<?php if ( get_header_image() ) : ?>
    <div id="site-header"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"> <img
                    src="<?php header_image(); ?>" width="<?php echo esc_attr( get_custom_header()->width ); ?>"
                    height="<?php echo esc_attr( get_custom_header()->height ); ?>"
                    alt="<?php echo esc_attr_e( 'Siteheader', 'kartpul' ); ?>"> </a></div>
<?php endif; ?>
    <!-- Header -->
<?php tmpmela_header_before(); ?>
    <header id="masthead"
            class="site-header header-fix <?php echo "header" . esc_attr( get_option( 'tmpmela_header_layout' ) ); ?> <?php echo esc_attr( tmpmela_sidebar_position() ); ?>">
                ...
                <div class="theme-container">
                    ...
                    <div class="header-right">
                        <div class="header-top-center">
                            <nav id="site-navigation" class="navigation-bar main-navigation"><a
                                        class="screen-reader-text skip-link" href="#content"
                                        title="<?php esc_attr_e( 'Skip to content', 'kartpul' ); ?>"><?php esc_html_e( 'Skip to content', 'kartpul' ); ?></a>
                                <div class="mega-menu">
									<?php wp_nav_menu( array(
                                ...
                                <div class="header-cart headercart-block">
                                    <div class="cart togg">
                                        ...
                                        <div class="shopping_cart tog"
                                             title="<?php esc_attr_e( 'View your shopping cart', 'kartpul' ); ?>">
